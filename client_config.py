...
PANEL_SPEED_RECT = pygame.Rect(PANEL_RECT.left+1, PANEL_SHIELD_BAR_RECT.bottom+2, PANEL_RECT.w-2, 16)
PANEL_WEAPON_DESC_BEGIN = pygame.Rect(PANEL_RECT.left+1, PANEL_SPEED_RECT.bottom+20, PANEL_RECT.w-2, 20)
...
PANEL_SALVAGE_BAR_RECT = pygame.Rect(PANEL_RECT.left+1, PANEL_RECT.bottom-22, PANEL_RECT.w-2, 20)
PANEL_STATION_SALVAGE_RECT = pygame.Rect(PANEL_RECT.left+1, PANEL_SALVAGE_BAR_RECT.top-20, PANEL_RECT.w-2, 16)
PANEL_POWER_BAR_RECT = pygame.Rect(PANEL_RECT.left+1, PANEL_STATION_SALVAGE_RECT.top-32, PANEL_RECT.w-2, 20)
PANEL_POWER_RECT = pygame.Rect(PANEL_RECT.left+1, PANEL_POWER_BAR_RECT.top-20, PANEL_RECT.w-2, 16)
PANEL_THRUST_BAR_RECT = pygame.Rect(PANEL_RECT.left+1, PANEL_POWER_RECT.top-32, PANEL_RECT.w-2, 20)
PANEL_THRUST_RECT = pygame.Rect(PANEL_RECT.left+1, PANEL_THRUST_BAR_RECT.top-20, PANEL_RECT.w-2, 16)
# Salvage on space.
