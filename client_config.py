...
PANEL_SPEED_RECT = pygame.Rect(PANEL_RECT.left+1, PANEL_SHIELD_BAR_RECT.bottom+20, PANEL_RECT.w-2, LABEL_HEIGHT)
...
# Card menu.
CARD_BEGIN_RECT = PANEL_HULL_RECT.copy()
INACTIVE_CARD_BUTTON_COLOR = (255, 0, 0)
ACTIVE_CARD_BUTTON_COLOR = (255, 85, 85)
