...
LOBBYLIST_RECT = pygame.Rect(CHAT_RECT.x+5, 5+LOBBYLIST_LABEL_RECT.bottom, 50, SCREEN_SIZE[1]-10-LOBBYLIST_LABEL_RECT.bottom)
START_GAME_RECT = CREATE_GAME_RECT
ACTIVE_STARTBUTTON_COLOR = (85, 255, 85)
INACTIVE_STARTBUTTON_COLOR = (0, 170, 0)
PLAYERLIST_RECT = pygame.Rect(5, 5, 100, SCREEN_SIZE[1]-10)
