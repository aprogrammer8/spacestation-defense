...
PANEL_NAME_RECT = pygame.Rect(PANEL_RECT.left+2, PANEL_RECT.top+3, PANEL_RECT.w, 16)
PANEL_HULL_RECT = pygame.Rect(PANEL_RECT.left+1, PANEL_NAME_RECT.bottom, PANEL_RECT.w, 16)
...
PANEL_SHIELD_RECT = pygame.Rect(PANEL_RECT.left+1, PANEL_HULL_BAR_RECT.bottom+20, PANEL_RECT.w, 16)
