...
PANEL_RECT = pygame.Rect(GAME_WINDOW_RECT.right, 0, SCREEN_SIZE[0]-GAME_WINDOW_RECT.right, SCREEN_SIZE[1])
...
DONE_BUTTON_RECT = pygame.Rect(PANEL_RECT.x+PANEL_RECT.w//2, 2, PANEL_RECT.w//2, 20)
